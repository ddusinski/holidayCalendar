insert into User(id,email, is_admin, password,MANAGER_ID)
values (default,'dominik.dusinski@gmail.com', true,'$2y$12$igST4lXWrTe/Hm/pSZGvVOZxtWpx6Tb7rX3SiyPMuu0ob2Vqal7PS', null);
insert into User(id,email, is_admin, password,MANAGER_ID)
values (default,'dusiud@gmail.com', false,'$2y$12$xm4L1sS7g90.nTX5LSATTOIcxZkceHbk9hU31i/HWMpzGSEYUX99i',1);
